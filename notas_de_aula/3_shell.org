...
A versão do Bourne se sobressaiu em número de funcionalidades e interativade, logo, n~ao foi díficil se tornar a padrão (:
...
3. Variáveis globais ou locais, que podem ser exportardas com o comando "export"
...
**** Operadores lógicos
No shell, existem dois operadores para representar a lógica matmática:
...
Como dito anteriormente, o sh suporta redirecionamento e entrada e saída, mas o que isso significa?
...
- Agora podemos executar esse script apenas cp, "./arquivo"
