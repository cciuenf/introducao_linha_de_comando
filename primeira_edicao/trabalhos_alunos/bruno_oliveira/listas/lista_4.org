...
O git é de fato o software de VCS. Já Github é uma plataforma de hospedagem de código fonte, que utiliza o git
Outros exemplos, são:Gitlab, BitBucket
...
https://github.com/Brunopalm/Topicos-em-SO/